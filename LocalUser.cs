    ...
    public class LocalUser : User
    {
        ...
        public void GenerateItemBill()
        {
            if (OrderItems.Count > 0)
            {
                ...
                Console.WriteLine(" --------------------------------------------------");
                Console.WriteLine(" {0,-35} {1,-10:C}", "Sub Total:", totalPrice);
                ...
                {
                    Console.WriteLine(" {0,-35} {1,-10:C}", "Special Gift:", special_gift=15);
                }
                else if (totalPrice > 5000 && totalPrice<10000)
                {
                    Console.WriteLine(" {0,-35} {1,-10:C}", "Special Gift:", special_gift = 30);

                }
                else if (totalPrice > 10000)
                {
                    Console.WriteLine(" {0,-35} {1,-10:C}", "Special Gift:", special_gift=100);
                }
                Console.WriteLine();
                Console.WriteLine(" {0,-35} {1,-10:C}", "Total:", totalPrice-TotaldiscountPrice-10-special_gift);
                Console.WriteLine(" --------------------------------------------------");
                Console.WriteLine(" |  ||   | |    |||  |  |||    | |  | ||  |");
                Console.WriteLine(" |  ||   | |    |||  |  |||    | |  | ||  |");
                Console.WriteLine(" |  ||   | |    |||  |  |||    | |  | ||  |");
